...
export class HotRequests {
    public static async fetch<TRequest extends Record<string | number, unknown> | unknown, TResponse>(req: HttpRequest<TRequest> & { method: `${HttpMethods}` }): Promise<HttpResponse<TResponse>> {
    ...
    public static head<TRequest extends Record<string | number, unknown> | unknown, TResponse>(req: HttpRequest<TRequest>) {
        return this.fetch<TRequest, TResponse>({ ...req, method: HttpMethods.HEAD });
    }

    public static get<TRequest extends Record<string | number, unknown> | unknown, TResponse>(req: HttpRequest<TRequest>) {
        return this.fetch<TRequest, TResponse>({ ...req, method: HttpMethods.GET });
    }

    public static post<TRequest extends Record<string | number, unknown> | unknown, TResponse>(req: HttpRequest<TRequest>) {
        return this.fetch<TRequest, TResponse>({ ...req, method: HttpMethods.POST });
    }

    public static put<TRequest extends Record<string | number, unknown> | unknown, TResponse>(req: HttpRequest<TRequest>) {
        return this.fetch<TRequest, TResponse>({ ...req, method: HttpMethods.PUT });
    }

    public static patch<TRequest extends Record<string | number, unknown> | unknown, TResponse>(req: HttpRequest<TRequest>) {
        return this.fetch<TRequest, TResponse>({ ...req, method: HttpMethods.PATCH });
    }

    public static delete<TRequest extends Record<string | number, unknown> | unknown, TResponse>(req: HttpRequest<TRequest>) {
        return this.fetch<TRequest, TResponse>({ ...req, method: HttpMethods.DELETE });
    }

    public static options<TRequest extends Record<string | number, unknown> | unknown, TResponse>(req: HttpRequest<TRequest>) {
